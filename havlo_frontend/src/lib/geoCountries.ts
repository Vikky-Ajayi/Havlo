// Shared country/region directory — the single source of truth for both
// the /countries page and the global country-switcher badge (CountryBadge).
// `flag` is the lowercase ISO 3166-1 alpha-2 code used by flagcdn.com
// (https://flagcdn.com/w80/{flag}.png).
export type GeoCountry = { name: string; description: string; flag: string };
export type GeoRegion = { name: string; countries: GeoCountry[] };
...
export const flagUrl = (iso: string, size: 'w40' | 'w80' = 'w40') =>
