    ...
    <div className="flex flex-col w-full overflow-hidden bg-white">
      ...
      <section className="w-full bg-white px-4 sm:px-10 lg:px-[100px] py-0 my-0">
        <AutoScrollReviews
          ...
          header={
            <>
              <h2 className="font-body text-[36px] font-medium leading-none tracking-[-0.8px] text-[#040504]">Excellent</h2>
      ...
      <section className="flex w-full flex-col items-center justify-center bg-gradient-to-b from-[#FF8FDD] via-[#FFC78A] to-[#FFD85C] px-4 sm:px-10 lg:px-[100px] py-10 my-0">
      ...
      {/* 4. What We Do */}
      <section className="flex flex-col items-center gap-14 bg-[#FEFFFF] px-4 sm:px-10 lg:px-[100px] py-10 my-0">
      ...
      <section className="relative flex flex-col items-center gap-5 bg-[#A409D2] px-4 sm:px-10 lg:px-[100px] overflow-hidden py-10 my-0">
      ...
      <section className="flex flex-col items-center gap-8 bg-white px-4 text-center py-10 my-0">
        <h2 className="font-display text-[44px] font-black leading-[1.1] text-[#050405] sm:text-[56px]">
