...
const WizardStyles = () => (
  <style>{`
    ...
    .slw-hero-image{height:392px;border-radius:0;margin:0 calc(50% - 50vw) 0;background:#fff;position:relative;overflow:hidden;z-index:1}
    ...
    @media (max-width: 900px){
      ...
      .slw-hero-image{margin:0 -14px 0;height:308px}
