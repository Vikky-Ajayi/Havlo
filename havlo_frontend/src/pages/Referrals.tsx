...
export const Referrals: React.FC = () => {
  return (
    <div className="flex flex-col w-full bg-white">
      ...
      {/* Who is this for */}
      <section className="flex flex-col lg:flex-row items-start gap-10 lg:gap-20 px-6 lg:px-[100px] bg-[#FEFFFF] py-10 my-0">
      ...
      {/* Who this is not for */}
      <section className="flex flex-col lg:flex-row items-start gap-10 lg:gap-20 px-6 lg:px-[100px] bg-[#040405] py-10 my-0">
        <div className="flex-1 flex flex-col gap-10">
      ...
      <section className="flex flex-col gap-10 px-6 lg:px-[100px] bg-[#050405] py-10 my-0">
        <div className="flex flex-col gap-10">
      ...
      {/* Ideal Referral */}
      <section className="flex flex-col gap-10 px-6 lg:px-[100px] bg-[#FFFFFE] py-10 my-0">
        <div className="flex flex-col gap-10">
          <div className="flex items-center gap-3">
      ...
      <section className="flex flex-col items-center gap-10 px-6 lg:px-[100px] bg-[#A409D2] py-10 my-0">
