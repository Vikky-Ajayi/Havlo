...
const propertyCards = [
  ...
  },
  {
    ...
    body: 'Off-plan developments, property portfolios, and high-yield blocks, structured to maximise your sterling returns and protect your wealth against shilling volatility.',
...
const testimonials = [
  {
    quote: 'I was nervous about buying from Nairobi. I thought I\'d have to be in London every week. We completed without me ever stepping on a plane. Incredible service.',
    author: 'Kamau W.',
    meta: 'Nairobi, bought 2-bed Manchester flat',
  },
  {
    ...
    author: 'Achieng O.',
    meta: 'Mombasa, HMO investment property',
  },
  {
    ...
    author: 'Mutua K.',
    meta: 'Kisumu, Leeds student property',
  },
];

const faqs = [
  ['Can Kenyans legally buy property in the UK?', 'Yes, completely. There are no restrictions on foreign nationals purchasing UK property, residential or commercial. You do not need a visa, residency, or UK bank account to buy.'],
  ...
  ['Can I get a mortgage as a non-UK resident?', 'Yes, though the process is different. Several UK lenders offer non-resident mortgages. We work with specialist brokers who handle overseas applications regularly, including Kenyan buyers.'],
  ['How do I transfer money from Kenya to the UK?', 'We guide you through compliant international transfer options, including FX specialists who offer better rates than high-street banks and understand CBK (Central Bank of Kenya) regulations.'],
  ['What taxes will I pay as a Kenyan buyer?', 'Stamp Duty Land Tax applies, with an overseas buyer surcharge of 2% on top of standard rates. Rental income is taxable in the UK, but deductions apply. We connect you with a UK tax advisor.'],
...
export const BuyAbroadKenya: React.FC = () => {
  usePageMeta({
    title: 'Buy UK Property from Kenya | Havlo Buy Abroad',
    description: 'A dedicated advisory service for Kenyan buyers purchasing residential, commercial, and investment property in the UK.',
    canonical: 'https://www.heyhavlo.com/buyabroad/kenya',
  });
      ...
      <main>
        <section className="buk-hero">
          <div className="buk-inner buk-hero-grid">
            <div className="buk-hero-copy">
              <h1>Own UK Property<br />from <span>Anywhere in Kenya</span></h1>
              ...
              <a className="buk-hero-cta" href="/buyabroad/uk/listings?country=kenya">Browse Properties for Sale</a>
        ...
        <section className="buk-market">
          <div className="buk-inner">
            ...
            <p className="buk-section-lead">For Kenyan investors, the UK offers legal clarity, strong rental demand, and long-term capital growth, backed by a system you can trust even when you're 7,000 miles away.</p>
        ...
        <section className="buk-section buk-testimonials">
          <div className="buk-inner">
            ...
            <h2>Kenyans buying UK property — without the stress</h2>
        ...
        <section className="buk-section buk-faq">
          <div className="buk-inner">
            ...
            <h2>Everything Kenyan buyers ask us</h2>
