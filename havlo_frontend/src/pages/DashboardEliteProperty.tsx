...
export const DashboardEliteProperty: React.FC = () => {
  ...
  return (
    <DashboardLayout title="Elite Property Introductions">
      <div className="max-w-[1162px] mx-auto px-4 sm:px-6 lg:px-0 space-y-6 lg:space-y-10 py-6 lg:py-10">
        {/* Hero Section */}
        <div className="relative overflow-hidden rounded-[20px] bg-black p-6 sm:p-10 lg:p-14 lg:min-h-[300px] flex flex-col justify-center">
