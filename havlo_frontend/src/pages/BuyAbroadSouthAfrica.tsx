...
const propertyCards = [
  ...
  },
  {
    ...
    body: 'Off-plan developments, property portfolios, and high-yield blocks, structured to maximise your sterling returns and protect your wealth against rand volatility.',
...
const testimonials = [
  {
    quote: 'I was nervous about buying from Johannesburg. I thought I\'d have to be in London every week. We completed without me ever stepping on a plane. Incredible service.',
    author: 'Sipho M.',
    meta: 'Johannesburg, bought 2-bed Manchester flat',
  },
  {
    ...
    author: 'Thandi N.',
    meta: 'Cape Town, HMO investment property',
  },
  {
    ...
    author: 'Lungelo D.',
    meta: 'Durban, Leeds student property',
  },
];

const faqs = [
  ['Can South Africans legally buy property in the UK?', 'Yes, completely. There are no restrictions on foreign nationals purchasing UK property, residential or commercial. You do not need a visa, residency, or UK bank account to buy.'],
  ...
  ['Can I get a mortgage as a non-UK resident?', 'Yes, though the process is different. Several UK lenders offer non-resident mortgages. We work with specialist brokers who handle overseas applications regularly, including South African buyers.'],
  ['How do I transfer money from South Africa to the UK?', 'We guide you through compliant international transfer options, including FX specialists who offer better rates than high-street banks and understand SARB (South African Reserve Bank) regulations.'],
  ['What taxes will I pay as a South African buyer?', 'Stamp Duty Land Tax applies, with an overseas buyer surcharge of 2% on top of standard rates. Rental income is taxable in the UK, but deductions apply. We connect you with a UK tax advisor.'],
...
export const BuyAbroadSouthAfrica: React.FC = () => {
  usePageMeta({
    title: 'Buy UK Property from South Africa | Havlo Buy Abroad',
    description: 'A dedicated advisory service for South African buyers purchasing residential, commercial, and investment property in the UK.',
    canonical: 'https://www.heyhavlo.com/buyabroad/southafrica',
  });
      ...
      <main>
        <section className="buk-hero">
          <div className="buk-inner buk-hero-grid">
            <div className="buk-hero-copy">
              <h1>Own UK Property<br />from <span>Anywhere in South Africa</span></h1>
              ...
              <a className="buk-hero-cta" href="/buyabroad/uk/listings?country=southafrica">Browse Properties for Sale</a>
        ...
        <section className="buk-market">
          <div className="buk-inner">
            ...
            <p className="buk-section-lead">For South African investors, the UK offers legal clarity, strong rental demand, and long-term capital growth, backed by a system you can trust even when you're 6,000 miles away.</p>
        ...
        <section className="buk-section buk-testimonials">
          <div className="buk-inner">
            ...
            <h2>South Africans buying UK property — without the stress</h2>
        ...
        <section className="buk-section buk-faq">
          <div className="buk-inner">
            ...
            <h2>Everything South African buyers ask us</h2>
