  ...
  return (
    <div className="buk-page">
      ...
      <style>{`
        ...
        .buk-market h2 { font-family: "Plus Jakarta Sans", Inter, sans-serif; font-size: 40px; font-weight: 600; line-height: 1.3; letter-spacing: -0.03em; margin-bottom: 12px; max-width: 100%; }
        .buk-section-lead { color: #555; font-size: 15px; line-height: 1.5; margin: 0; max-width: 100%; }
        ...
        .buk-stat-item { border-left: 4px solid #8b00d4; padding: 2px 0 10px 22px; }
        .buk-stat-item:not(:last-child) { margin-bottom: 10px; }
        .buk-stat-item strong { display: block; font-family: "Clash Display Variable", "Clash Display", Inter, sans-serif; font-size: 36px; font-weight: 500; line-height: 1.1; letter-spacing: -0.01em; color: #111; margin-bottom: 2px; }
