  ...
  return (
    <div className="buk-page">
      ...
      <style>{`
        ...
        .buk-market h2 { font-family: "Plus Jakarta Sans", Inter, sans-serif; font-size: 40px; font-weight: 600; line-height: 1.3; letter-spacing: -0.03em; margin-bottom: 12px; max-width: 620px; }
        .buk-section-lead { color: #555; font-size: 15px; line-height: 1.5; margin: 0; max-width: 620px; }
