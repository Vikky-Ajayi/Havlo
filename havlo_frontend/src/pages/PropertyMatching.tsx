...
export const PropertyMatching: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full bg-white">
      {/* Hero Section */}
      <section className="relative flex flex-col items-center pt-[68px] lg:pt-24 pb-12 lg:pb-0 overflow-hidden bg-gradient-to-b from-[#FFB0E8] to-[#FEEAA0] lg:h-[700px] px-6 lg:px-[100px]">
      ...
      <section className="flex flex-col items-center gap-14 bg-white px-6 lg:px-[100px] pt-32 pb-[84px] lg:pb-32">
