...
export const BuyAbroadUkAgents: React.FC = () => {
  usePageMeta({
    ...
    canonical: 'https://www.heyhavlo.com/buyabroad/uk/agents',
  });
    ...
    if (step === 'submitted') {
      return (
        <div className="buk-result">
          ...
          <a className="buk-whatsapp" href="https://whatsapp.com/channel/0029VbD9tlMBlHplTtkA8c0A" target="_blank" rel="noopener noreferrer">
