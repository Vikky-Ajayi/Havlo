...
const RelaunchHeroSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-[600px] lg:h-[750px] overflow-hidden py-10 my-0">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 lg:px-[100px] pt-[84px] pb-32 lg:pt-32 lg:pb-40 min-h-[600px] lg:h-[750px]">
    ...
    <div className="flex flex-col w-full overflow-hidden bg-white">
      ...
      <section className="relative flex flex-col items-center gap-8 bg-havlo-purple px-4 text-center py-10 my-0">
        ...
        <div className="relative z-10 flex flex-col items-center gap-8">
          <h2 className="max-w-[750px] font-display text-[36px] sm:text-[56px] lg:text-[72px] font-black leading-[1.1] text-white pt-[40px]">
