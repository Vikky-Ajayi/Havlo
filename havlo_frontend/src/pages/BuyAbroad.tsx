...
export const BuyAbroad: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full overflow-hidden bg-white">
      ...
      <section className="relative flex flex-col items-start gap-14 bg-black px-4 py-[60px] md:py-24 sm:px-10 lg:px-[100px]">
      ...
      <section className="relative flex flex-col items-center gap-14 bg-[#F9F9F8] px-4 pt-24 pb-[60px] md:py-24 sm:px-10 lg:px-[100px]">
      ...
      <section className="relative flex flex-col items-center gap-16 bg-[#A409D2] px-4 pt-32 md:pt-32 pb-[84px] md:pb-48 sm:px-10 lg:px-[100px] overflow-hidden" style={{ borderRadius: '0 0 50% 50% / 0 0 60px 60px' }}>
              ...
              <div className="flex flex-col gap-2">
                ...
                {step.showTeam && (
                  <div className="mt-4 flex items-center gap-3">
                    ...
                    <span className="inline-flex items-center gap-2 rounded-full bg-[#22C55E] px-4 py-2 font-body text-[13px] font-extrabold uppercase tracking-[0.14em] text-white shadow-sm rounded-tl-[8px] rounded-tr-[8px] rounded-br-[8px] rounded-bl-[8px]">
      ...
      {/* 7. CTA Section */}
      <section className="flex flex-col items-center gap-10 bg-white px-4 py-[60px] md:py-24 sm:px-10 lg:px-[100px]">
