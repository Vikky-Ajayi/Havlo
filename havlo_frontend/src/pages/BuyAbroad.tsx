...
export const BuyAbroad: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full overflow-hidden bg-white">
      ...
      <section className="relative flex flex-col items-start gap-14 bg-black px-4 py-14 md:py-24 sm:px-10 lg:px-[100px]">
      ...
      <section className="relative flex flex-col items-center gap-14 bg-[#F9F9F8] px-4 pt-24 pb-14 md:py-24 sm:px-10 lg:px-[100px]">
      ...
      <section className="relative flex flex-col items-center gap-16 bg-[#A409D2] px-4 pt-32 md:pt-32 pb-20 md:pb-48 sm:px-10 lg:px-[100px] overflow-hidden" style={{ borderRadius: '0 0 50% 50% / 0 0 60px 60px' }}>
      ...
      {/* 7. CTA Section */}
      <section className="flex flex-col items-center gap-10 bg-white px-4 py-14 md:py-24 sm:px-10 lg:px-[100px]">
