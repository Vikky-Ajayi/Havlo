...
export const AboutUs: React.FC = () => {
  return (
    <div className="flex flex-col w-full overflow-hidden bg-white">
      <section className="bg-gradient-to-b from-[#FFB0E8] to-[#FEEAA0] px-4 py-1 md:py-20 sm:px-10 lg:px-[100px]">
      ...
      <section className="bg-[#F9F9F8] px-4 py-1 md:py-20 sm:px-10 lg:px-[100px]">
