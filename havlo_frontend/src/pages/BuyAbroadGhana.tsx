...
const propertyCards = [
  ...
  },
  {
    ...
    body: 'Off-plan developments, property portfolios, and high-yield blocks, structured to maximise your sterling returns and protect your wealth against cedi volatility.',
...
const faqs = [
  ['Can Ghanaians legally buy property in the UK?', 'Yes, completely. There are no restrictions on foreign nationals purchasing UK property, residential or commercial. You do not need a visa, residency, or UK bank account to buy.'],
  ...
  ['Can I get a mortgage as a non-UK resident?', 'Yes, though the process is different. Several UK lenders offer non-resident mortgages. We work with specialist brokers who handle overseas applications regularly, including Ghanaian buyers.'],
  ['How do I transfer money from Ghana to the UK?', 'We guide you through compliant international transfer options, including FX specialists who offer better rates than high-street banks and understand Bank of Ghana regulations.'],
  ['What taxes will I pay as a Ghanaian buyer?', 'Stamp Duty Land Tax applies, with an overseas buyer surcharge of 2% on top of standard rates. Rental income is taxable in the UK, but deductions apply. We connect you with a UK tax advisor.'],
...
export const BuyAbroadGhana: React.FC = () => {
  usePageMeta({
    title: 'Buy UK Property from Ghana | Havlo Buy Abroad',
    description: 'A dedicated advisory service for Ghanaian buyers purchasing residential, commercial, and investment property in the UK.',
    canonical: 'https://www.heyhavlo.com/buyabroad/ghana',
  });
      ...
      <main>
        ...
        <section className="buk-market">
          <div className="buk-inner">
            ...
            <p className="buk-section-lead">For Ghanaian investors, the UK offers legal clarity, strong rental demand, and long-term capital growth, backed by a system you can trust even when you're 4,000 miles away.</p>
        ...
        <section className="buk-section buk-testimonials">
          <div className="buk-inner">
            ...
            <h2>Ghanaians buying UK property — without the stress</h2>
        ...
        <section className="buk-section buk-faq">
          <div className="buk-inner">
            ...
            <h2>Everything Ghanaian buyers ask us</h2>
