...
class RightmoveListing(Base):
    ...
    price_native: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    price_currency: Mapped[str] = mapped_column(String(3), nullable=False, default="GBP")
    address: Mapped[str] = mapped_column(String(500), nullable=False)
    city: Mapped[str] = mapped_column(String(100), nullable=False, index=True)
    region: Mapped[str] = mapped_column(String(100), nullable=False, default="")
    country: Mapped[str] = mapped_column(String(20), nullable=False, default="uk", index=True)
    source: Mapped[str] = mapped_column(String(30), nullable=False, default="rightmove")
...
class ProductAccessToken(Base):
    ...
    email: Mapped[str] = mapped_column(String(320), nullable=False, index=True)
    product_scope: Mapped[str] = mapped_column(String(50), nullable=False, index=True)
