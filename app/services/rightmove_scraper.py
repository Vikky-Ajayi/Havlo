...
# Re-verified 2026-08-30 by driving Rightmove's live location search UI for
# every entry below: 99 of the 107 previous IDs were wrong (many resolved to
# 0-result or wrong-place matches — e.g. old "London" pointed at a Ballyclare,
# NI village; old "Birmingham" pointed at a Welsh village). All IDs below were
# confirmed by resolving each name through Rightmove's own typeahead search
# and reading the resulting REGION^<id> off the live results-page URL.
# "Newport" / "Newport Gwent" both correctly resolve to the same place
# (Newport, South Wales) — kept as two aliases; _load_all_locations() dedupes
# by ID so this costs nothing at runtime.
KNOWN_LOCATIONS: list[tuple[str, str]] = [
    ...
    ("Leicester",       "REGION%5E789"),
    ("Southampton",     "REGION%5E1231"),
    ("Oxford",          "REGION%5E1036"),
    ("Cambridge",       "REGION%5E274"),
    ("Brighton",        "REGION%5E93554"),
    ("Coventry",        "REGION%5E368"),
    ("Derby",           "REGION%5E418"),
    ("Exeter",          "REGION%5E494"),
    ("Plymouth",        "REGION%5E1073"),
    ("Reading",         "REGION%5E1114"),
    ("York",            "REGION%5E1498"),
    ("Bath",            "REGION%5E116"),
    ("Chester",         "REGION%5E313"),
    ("Wolverhampton",   "REGION%5E1476"),
    ("Bournemouth",     "REGION%5E194"),
    ("Portsmouth",      "REGION%5E1089"),
    ("Norwich",         "REGION%5E1018"),
    ("Stoke",           "REGION%5E1271"),
    ("Hull",            "REGION%5E665"),
    ("Swansea",         "REGION%5E1305"),
    ("Aberdeen",        "REGION%5E4"),
    ("Dundee",          "REGION%5E452"),
    ("Milton Keynes",   "REGION%5E940"),
    ("Swindon",         "REGION%5E1306"),
    ("Luton",           "REGION%5E876"),
    ("Peterborough",    "REGION%5E1061"),
    ("Middlesbrough",   "REGION%5E933"),
    ("Ipswich",         "REGION%5E689"),
    ("Southend",        "REGION%5E1232"),
    # ── North West England ───────────────────────────────────────────────────────
    ("Blackpool",       "REGION%5E168"),
    ("Preston",         "REGION%5E1097"),
    ("Blackburn",       "REGION%5E167"),
    ("Bolton",          "REGION%5E182"),
    ("Wigan",           "REGION%5E1452"),
    ("Warrington",      "REGION%5E1403"),
    ("Burnley",         "REGION%5E252"),
    ("Stockport",       "REGION%5E1268"),
    ("Salford",         "REGION%5E1164"),
    ("Rochdale",        "REGION%5E1134"),
    ("Oldham",          "REGION%5E1025"),
    ("Bury",            "REGION%5E257"),
    # ── Yorkshire & Humber ──────────────────────────────────────────────────────
    ("Bradford",        "REGION%5E198"),
    ("Huddersfield",    "REGION%5E664"),
    ("Wakefield",       "REGION%5E1386"),
    ("Doncaster",       "REGION%5E430"),
    ("Barnsley",        "REGION%5E108"),
    ("Rotherham",       "REGION%5E1145"),
    ("Harrogate",       "REGION%5E598"),
    ("Scarborough",     "REGION%5E1179"),
    # ── North East England ───────────────────────────────────────────────────────
    ("Sunderland",      "REGION%5E1295"),
    ("Gateshead",       "REGION%5E544"),
    ("Darlington",      "REGION%5E406"),
    ("Hartlepool",      "REGION%5E601"),
    ("Durham",          "REGION%5E460"),
    ("Carlisle",        "REGION%5E283"),
    # ── Midlands ────────────────────────────────────────────────────────────────
    ("Northampton",     "REGION%5E1014"),
    ("Cheltenham",      "REGION%5E308"),
    ("Gloucester",      "REGION%5E556"),
    ("Worcester",       "REGION%5E1483"),
    ("Walsall",         "REGION%5E1392"),
    ("Telford",         "REGION%5E1323"),
    ("Shrewsbury",      "REGION%5E1208"),
    ("Hereford",        "REGION%5E629"),
    ("Lincoln",         "REGION%5E804"),
    ("Mansfield",       "REGION%5E906"),
    ("Chesterfield",    "REGION%5E315"),
    ("Grimsby",         "REGION%5E578"),
    # ── South East England ───────────────────────────────────────────────────────
    ("Guildford",       "REGION%5E580"),
    ("Crawley",         "REGION%5E378"),
    ("Canterbury",      "REGION%5E279"),
    ("Maidstone",       "REGION%5E897"),
    ("Colchester",      "REGION%5E347"),
    ("Chelmsford",      "REGION%5E307"),
    ("Basingstoke",     "REGION%5E115"),
    ("Eastbourne",      "REGION%5E470"),
    ("Hastings",        "REGION%5E605"),
    ("Worthing",        "REGION%5E1487"),
    ("Woking",          "REGION%5E1474"),
    ("Aldershot",       "REGION%5E22"),
    ("Slough",          "REGION%5E1217"),
    ("Watford",         "REGION%5E1408"),
    ("Stevenage",       "REGION%5E1263"),
    # ── South West England ───────────────────────────────────────────────────────
    ("Truro",           "REGION%5E1365"),
    ("Torquay",         "REGION%5E1350"),
    # ── Scotland ────────────────────────────────────────────────────────────────
    ("Stirling",        "REGION%5E1266"),
    ("Perth",           "REGION%5E1060"),
    ("Inverness",       "REGION%5E687"),
    ("Falkirk",         "REGION%5E501"),
    ("Paisley",         "REGION%5E1040"),
    ("Livingston",      "REGION%5E815"),
    ("Kirkcaldy",       "REGION%5E754"),
    # ── Wales ───────────────────────────────────────────────────────────────────
    ("Cardiff",         "REGION%5E281"),
    ("Newport",         "REGION%5E991"),
    ("Newport Gwent",   "REGION%5E991"),
    ("Wrexham",         "REGION%5E1489"),
    ("Llanelli",        "REGION%5E827"),
]
